...
<style>
div.blue { background-color:#2b3f60;}
</style>
...
The task of plotting continuous variables is non-negotiable any data science project. There can be lots of reasons for this. You may need to ensure that your data is normally distributed (a requirement for certain statistical analyses), or you might need to identify and remove outliers.
