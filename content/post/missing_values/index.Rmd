...
If we're reading the data in from a csv, it's easy enough to specify these strings at the time of import:
...
But sometimes it isn't possible to specify a range of missing value codes at the time of data import.

Here where the `naniar` package becomes really useful. Using this package, we can easily replace any predetermined missing value codes (e.g. -999) with explicit NA values.
